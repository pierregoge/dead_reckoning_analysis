function [data_tag, data_tt,duration] = compute_openLogger_time(srate,limit_analyse_1,limit_analyse_2,seconds_offset_openlogger,plot_raw_data_logger,magoffset,gyrooffset,acceloffset)
