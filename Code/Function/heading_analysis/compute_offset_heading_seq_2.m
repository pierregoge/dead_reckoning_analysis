function [offset_heading_s] = compute_offset_heading_seq_2(step_traj,data_heading)
...
offset_heading_s(i,2) = (mean(diff_heading_s(1:step_traj(i+1)-step_traj(i),2))+mean(diff_heading_s(1:step_traj(i+1)-step_traj(i),2)))/2;
