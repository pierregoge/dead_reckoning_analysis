function [heading,pitch,roll,quaternion] = compute_madgwick_filter_5(data_imu,beta,srate)
...
data_imu.accel(:,2) = -1*data_imu.accel(:,2);
data_imu.accel(:,1) = -1*data_imu.accel(:,1);
