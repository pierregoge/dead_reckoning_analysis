function [diff_eul_yaw,diff_cumul_eul_yaw] = err_heading_analysis(data_heading,data_heading_ref,limit_analyse,offset_heading,nb_plot)

yaw(:,1:nb_plot) = data_heading.madgwick(:,:);
yaw(:,nb_plot+1) = data_heading.saam(:,1);
...
for i=limit_analyse(1)+1:limit_analyse(2)
