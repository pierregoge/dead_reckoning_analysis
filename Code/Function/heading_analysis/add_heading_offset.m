function [data_heading_s] = add_heading_offset(data_heading,offset_heading)


    
    yaw(:,1) = (data_heading.madgwick(:,:)+offset_heading(:,1))/180*pi;
    yaw(:,2) = (data_heading.saam(:,1)+offset_heading(:,1))/180*pi;
