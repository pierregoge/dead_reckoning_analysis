function [diff_eul_yaw,diff_cumul_eul_yaw] = err_heading_analysis_seq(data_heading,data_heading_ref,limit_analyse,offset_heading,nb_plot)

yaw(:,1:nb_plot) = data_heading.madgwick(:,:)+offset_heading(1,1:nb_plot);
yaw(:,nb_plot+1) = data_heading.saam(:,1)+offset_heading(1,nb_plot+1);
