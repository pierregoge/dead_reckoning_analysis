function [POS_RMS] = compute_2DRMS_2(X10,Y10,X_REF,Y_REF)
% 
...
for i=1:length(X10(:,1))
   diff_pos_X10(i,:) = X10(i,:)-X_REF(i,1);
   diff_pos_Y10(i,:) = Y10(i,:)-Y_REF(i,1);

end


POS_RMS(1,:) = sqrt(mean(diff_pos_X10.^2+diff_pos_Y10.^2));
