function [diff_speed,diff_cumul_speed, diff_eul_yaw,diff_cumul_eul_yaw] = err_speed_yaw_3(data_heading,data_speed,offset_heading)

yaw(:,1) = (data_heading.madgwick(:,1)+offset_heading);
