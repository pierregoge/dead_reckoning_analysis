function [diff_speed,diff_cumul_speed, diff_eul_yaw,diff_cumul_eul_yaw] = err_speed_heading_ref_2(data_heading,data_speed)

yaw(:,1) = (data_heading.madgwick(:,1));
yaw(:,2) = (data_heading.saam(:,1));
...
diff_speed(:,2) = data_speed.ref(:,1)-data_speed.odba(:,1);
