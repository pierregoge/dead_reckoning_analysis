function [data_analyse_speed,limit_speed_analyse] = compute_variable_speed_3(limit,odba,nb_spin,no_spin,data_tag,v_acc_ned_3axis_f,speed_100,speed_100_raw,data_imu)
...
data_analyse_speed(:,9) = v_acc_ned_3axis_f(limit_speed_analyse,1);
data_analyse_speed(:,10) = data_imu.accel_d(limit_speed_analyse,1);
