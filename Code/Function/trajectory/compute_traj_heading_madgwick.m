function [X3,Y3,Z3] = compute_traj_heading_madgwick(data_pitch,data_heading,data_speed, decli,srate,i)
...
Pitch = data_pitch.madgwick(:,i)/180*pi;
Head = (data_heading.madgwick(:,i))/180*pi;
