function [X3,Y3,Z3,Head] = compute_traj_test(data_orientation,data_heading,data_speed, decli,srate)
...
Head = (data_heading.ref(:,1)-95)/180*pi;
Head = Head + decli;
elseif j == 2
Pitch = data_orientation.trigo(:,1)/180*pi;
