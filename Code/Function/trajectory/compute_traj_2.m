function [X3,Y3,Z3] = compute_traj_2(data_orientation,data_heading,data_speed, decli,srate)
 ...
 X3= nan(size(data_heading.madgwick(:,1),1),2);
 Y3= nan(size(data_heading.madgwick(:,1),1),2);
 Z3= nan(size(data_heading.madgwick(:,1),1),2);
